...
export default function Navbar() {
  ...
  const handleLogout = () => {
    storage.clear();
    setIsLoggedIn(false);
    router.push(`/${locale}`); // Routing To Home Page
  };
      ...
      items: [
        {
          ...
          path: "/",
          icon: <FiHome size={20} />,
          activeIcon: <FiHome size={20} className="text-white" />,
        },
        {
          key: "products",
          path: "/products",
          icon: <FiBox size={20} />,
          activeIcon: <FiBox size={20} className="text-white" />,
        },
        {
          key: "contact",
          path: "/contact",
          icon: <FiMail size={20} />,
          activeIcon: <FiMail size={20} className="text-white" />,
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          activeIcon: <FiActivity size={20} className="text-white" />,
        },
        {
          key: "privacy",
          path: "/privacy",
          icon: <FiShield size={20} />,
          activeIcon: <FiShield size={20} className="text-white" />,
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          activeIcon: <FiHelpCircle size={20} className="text-white" />,
        },
      ],
    },
    {
        ...
        ? [
            {
              ...
              activeIcon: <FiLogOut size={20} className="text-white" />,
            },
          ]
        : [
            {
              ...
              icon: <FiUser size={20} />,
              activeIcon: <FiUser size={20} className="text-white" />,
            },
          ],
    },
  ];
  ...
  const isActive = (path: string | string[]) => {
    ...
    return isHome
      ? path === "/"
      : cleanedPath === path.toLowerCase() ||
          cleanedPath.startsWith(path.toLowerCase() + "/");
  };
                ...
                <button
                  ...
                  className={`${
                    active
                      ...
                      : "text-[#000000CC]"
                  } flex items-center gap-2 text-[13px] rounded-[10px] py-1.5 px-2.5 w-full  cursor-pointer`}
                >
                ...
                <li className="relative z-50">
                  {toggle && (
                    <span className="absolute -bottom-[35px] left-1/2 -translate-x-1/2">
                      ...
                      >
                        <path
                          d="M40 64L0.162827 0.25L79.8372 0.25L40 64Z"
                          fill="#FE93B9"
                        />
                      </svg>
                    </span>
                  ...
                  >
                    ...
                    >
                      <path
                        d="M52.5 13.125H35C33.975 13.125 33.125 12.275 33.125 11.25C33.125 10.225 33.975 9.375 35 9.375H52.5C53.525 9.375 54.375 10.225 54.375 11.25C54.375 12.275 53.525 13.125 52.5 13.125Z"
                        fill="#393939"
                      />
                      <path
                        d="M52.5 25.625H35C33.975 25.625 33.125 24.775 33.125 23.75C33.125 22.725 33.975 21.875 35 21.875H52.5C53.525 21.875 54.375 22.725 54.375 23.75C54.375 24.775 53.525 25.625 52.5 25.625Z"
                        fill="#393939"
                      />
                      <path
                        d="M52.5 38.125H7.5C6.475 38.125 5.625 37.275 5.625 36.25C5.625 35.225 6.475 34.375 7.5 34.375H52.5C53.525 34.375 54.375 35.225 54.375 36.25C54.375 37.275 53.525 38.125 52.5 38.125Z"
                        fill="#393939"
                      />
                      <path
                        d="M52.5 50.625H7.5C6.475 50.625 5.625 49.775 5.625 48.75C5.625 47.725 6.475 46.875 7.5 46.875H52.5C53.525 46.875 54.375 47.725 54.375 48.75C54.375 49.775 53.525 50.625 52.5 50.625Z"
                        fill="#393939"
                      />
                      <path
                        d="M19.8 26.875H12.7C8.85 26.875 6.875 24.925 6.875 21.05V13.95C6.875 10.1 8.825 8.125 12.7 8.125H19.825C23.675 8.125 25.65 10.075 25.65 13.95V21.075C25.625 24.925 23.675 26.875 19.8 26.875Z"
                        fill="#393939"
                      />
                    </svg>
                  </button>
